...
<div id="main-content-wp" class="info-account-page">
    <div class="section" id="title-page">
        <div class="clearfix">
            ...
            <h3 id="index" class="fl-left" style="padding-left:160px;">Cập nhật tài khoản</h3>
        </div>
    </div>
        ...
        <div id="sidebar" class="fl-left">
            <ul >
                <li style=" padding: 10px 15px;border-bottom: 1px solid #ddd;">
                    <a style="color: black" href="?modules=users&controller=index&action=pass" title="">Đổi mật khẩu</a>
                </li>
                <li style=" padding: 10px 15px;border-bottom: 1px solid #ddd;">
                    <a style="color: black" href="?modules=users&controllers=index&action=logout" title="">Thoát</a>
                </li>
            </ul>
        </div>
