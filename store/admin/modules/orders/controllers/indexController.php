...
function detailAction(){
	...
	foreach ($data_order as $key => $value) {
		...
		$data[$key]['num_total']  = $value['num_total'];
		$data[$key]['code'] = $data_product['code'];
		$data[$key]['image'] = $data_product['image'];
		$data[$key]['name'] = $data_product['name'];
		$data[$key]['promotional_price'] = $data_product['promotional_price'];
		if($value['num_total'] > $data_product['quantity']){
