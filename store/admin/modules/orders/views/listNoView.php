                        ...
                        <table class="table list-table-wp">
                            <thead>
                                <tr>
                                    ...
                                    <td  style="padding-left:53px"><span class="thead-text">Mã đơn hàng</span></td>
                                    <!-- <td><span class="thead-text">Thời gian đặt</span></td> -->
                                    <td style="padding-left:30px"><span class="thead-text">Khách hàng</span></td>
                                    <td><span class="thead-text">Tổng số mặt hàng</span></td>
                                    <td style="padding-left:25px"><span class="thead-text">Tổng tiền</span></td>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="text-align:center"><span class="tbody-text"><?php echo ($key +1); ?></span></td>
                                    ...
                                    <td style="padding-left:20px"><span class="tbody-text"><a href="?modules=orders&controllers=index&action=detail&id_order=<?php echo $value['id']; ?>">xử lý</a></span></td>
                                </tr>
