            ...
            <div id="container">
                <div id="header-wp">
                    ...
                    <div id="head-body" class="clearfix">
                        <div class="wp-inner">
                            <a href="?modules=home" title="" id="logo" class="fl-left"><img src="public/images/logostore.png" alt=""></a>
                            ...
                            <div id="action-wp" class="fl-right">
                                <div id="advisory-wp" class="fl-left">
                                    ...
                                    <span class="phone">0935.520.065</span>
                                </div>
                                ...
                                <div id="cart-wp" class="fl-right">
                                    ...
                                    <div id="dropdown">
                                        ...
                                        <ul class="list-cart">
                                            ...
                                            <li class="clearfix">
                                                ...
                                                <div class="info fl-right">
                                                    ...
                                                    <p class="price"><?php echo $value['promotional_price'].'VNĐ'; ?></p>
                                                    <p class="num_total">Số lượng: <span><?php echo $value['num_total'] ;?></span></p>
                                                </div>
                                            </li>
                                             <?php }}; ?>
                                        </ul>
                                        <div class="total-price clearfix">
                                            ...
                                            <p class="price fl-right"><?php if(isset($_SESSION['cart']['buy'])&&!empty($_SESSION['id_customer'])) echo $_SESSION['cart']['info']['total']."0.000VNĐ"; else echo "0 VNĐ"; ?></p>
                                        </div>
