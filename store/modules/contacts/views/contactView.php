        ...
        <div class="section" id="order-review-wp">
            ...
            <div class="section-detail">
                <table class="shop-table">
                    <tbody>
                        <tr class="cart-item">
                            <td class="product-name">K74 Ngô Thì Nhậm - Liên Chiểu - Đà Nẵng</td>
                        </tr>
                        <tr class="cart-item">
                            <td class="product-name">Mobile: 0935.520.065</td>
                        </tr>
                        <tr class="order-total">
                            <td><strong class="total-price">Email: khoakhoa3012@gmail.com</strong></td>
                        </tr>
                    </tbody>
                    <tfoot>
                        <tr class="order-total">
                        		...
                        		<strong class="total-price">
                        			<ul>
										<li style="display: inline-block; padding: 0px 20px; font-size: 50px;">
											<a style="color:gray;" href="https://www.facebook.com/profile.php?id=100025808741026"><i class="fa fa-facebook"></i></a>
										</li>
										<!-- <li style="display: inline-block;padding: 0px 20px;font-size: 50px;">
											<a style="color:gray;" href="https://github.com/DangKhoaALC"><i  class="fa fa-github"></i></a>
										</li>
                                        <li style="display: inline-block;padding: 0px 20px;font-size: 50px;">
											<a style="color:gray;" href="https://gitlab.com/DangKhoaALC"><i  class="fa fa-gitlab"></i></a>
										</li> -->
									</ul>
                        		</strong>
                        	</td>
