                ...
                <div class="section-detail">
                    <table class="shop-table">
                        ...
                        <tbody>
                            ...
                            <tr class="cart-item">
                                <td class="product-name"><?php echo $value['name']; ?><strong class="product-quantity">x <?php echo $value['num_total']; ?></strong></td>
                                <td class="product-total"><?php echo $value['sub_total']."0.000VND"; ?></td>
                            </tr>
                             <?php }}; ?>
                        </tbody>
                        <tfoot>
                            <tr class="order-total">
                                <td>Tổng đơn hàng:</td>
                                <td><strong class="total-price"><?php if(isset($_SESSION['cart']['buy'])) echo $_SESSION['cart']['info']['total']."0.000VND"; else echo "0 VND"; ?></strong></td>
                            </tr>
                        </tfoot>
                    </table>
