                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $value['promotional_price']."VNĐ"; ?></td>
                            <td>
                                <input min="1" style="width: 60px;" type="number" name="num_total[<?php echo $value['id']; ?>]" value="<?php echo  $value['num_total']; ?>" class="num-order" >
                            </td>
                            <td><?php echo $value['sub_total']."0.000VNĐ"; ?></td>
                            <td>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="7">
                                <div class="clearfix">
                                    <p id="total-price" class="fl-right">Tổng giá: <span><?php if(isset($_SESSION['cart']['buy'])&&!empty($_SESSION['id_customer'])) echo $_SESSION['cart']['info']['total']."0.000VNĐ"; else echo "0 VNĐ"; ?></span></p>
                                </div>
                            </td>
                        </tr>
                        <tr>
